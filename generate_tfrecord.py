...
# This is needed to find the object_detection folder inside the cloned 
# tensorflow folders
import sys
...
def class_text_to_int(row_label):
    if row_label == 'wolf':
        ...
        return 9
    elif row_label == 'hedgehog':
        return 10
    elif row_label == 'giraffe':
        return 11
    elif row_label == 'hippo':
        return 12
    elif row_label == 'elephant':
        return 13
    elif row_label == 'bat':
        return 14
    elif row_label == 'capybara':
        return 15
